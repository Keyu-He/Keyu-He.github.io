...
Hi! I'm Keyu He, a **Master's in NLP** @ [Carnegie Mellon University](https://www.cmu.edu/) [SCS](https://www.cs.cmu.edu/). Previously, I earned my B.S. from the [University of Southern California](https://www.usc.edu/), where I double‑majored in **Computer Science** and **Applied & Computational Mathematics**.

I am passionate about **_socially intelligent AI agents_** that can reason about people, interact naturally, and support human learning. At CMU, I'm researching **socially intelligent AI** with Professor [Maarten Sap](https://maartensap.com/), and **human-centered AI evaluation** with Professor [Sherry Tongshuang Wu](https://www.cs.cmu.edu/~sherryw/). Previously at USC, I conducted NLP research in the [INK Lab](https://inklab.usc.edu/) and [DILL Lab](https://dill-lab.github.io/) under Professors [Xiang Ren](https://www.seanre.com/) and [Swabha Swayamdipta](https://swabhs.com/).
